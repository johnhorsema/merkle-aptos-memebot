...
Write a post for twitter from the perspective of {{agentName}}. Try to write something different than previous posts which are added here as context. Do not add commentary or ackwowledge this request, just write the post. Use \\n\\n (double spaces) between statements. Add hashtags at the end related to the post. Must not exceed 280 character limit.
</system_task>
